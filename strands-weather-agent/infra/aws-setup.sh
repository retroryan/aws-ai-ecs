...
echo "Strands Weather Agent ECS"
echo "==================================="
echo ""
...
# Models supported by the strands weather agent (from services.cfn)
...
cat > bedrock.env << EOF
# Bedrock Configuration for Strands Weather Agent - Generated by aws-setup.sh
# Generated on: $(date)
